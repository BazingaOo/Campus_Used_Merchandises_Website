...
<a href="shop_jsp/user_Registe.jsp">注册</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="user_jsp/user_Registe.jsp">忘记密码</a>
<div id="adminLogin_bottom" class="adminLogin_bottom" >
 <input type="submit" value="" class="sub" style="background:url(image/shop/admin_three.png)"/><br/><br/>
 <a href="shop_jsp/shop_HomePage.jsp"><input type="button" value="" class="go" style="background:url(image/user/go_index.png)"/></a>
  </div>
  </s:form> 
</div>
</body>
