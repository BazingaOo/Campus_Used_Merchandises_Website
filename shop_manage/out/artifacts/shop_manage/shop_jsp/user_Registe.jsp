...
<!-- <input type="text" id="nickname" class="nickname error" maxlength="24" data-bind="textInput: nickname, event: {blur:checkDirtyNickname,focus:onNicknameFocus}, css:{error: typeof nicknameStatus() == 'string'}" tabindex="3"> -->
<h3>
                    ...
                    <div id="wizard">
                        ...
                        <div class="items">
                            <div class="page">
                                ...
                                <p><label>头像：</label><input type="file" class="input" name="userImage" /></p>
                                <br/>
                                <div class="btn">
