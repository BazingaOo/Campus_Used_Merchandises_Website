 ...
 <form id="publish"  action="shop_updateGood.action?findByuserid=${sessionScope.loginuser.userId}&goodState=daishenhe"method="post" enctype="multipart/form-data">
	<div class="bottom-center">       	 
        	<dl id="pubContanier"> <input type="hidden"   name="findgoodid"  id="good-id" value="${requestScope.good.goodId}"/>
                ...
                <hr class="good-hr"></hr>
                <dd class="good">商品名称&nbsp;<input class="good-ull" name="goodName" type="text" value="${requestScope.good.goodName}" placeholder="最多14个字" id="good-name"></dd>
                <hr class="good-hr"></hr>
        ...
        <div id="note" class="note">
            <font color="#dedddd">${requestScope.good.goodDescription}</font>
                ...
                <dd class="goodTwo">商品价格&nbsp;<input class="good-ull" name="goodPrice" type="text" value="${requestScope.good.goodPrice}" placeholder="输入数字" id="good-price"></dd></hr>
                <hr class="good-hr">
