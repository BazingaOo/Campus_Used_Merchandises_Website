...
<div class="shenhe_right" >
	...
	<div class="main" >
		<form  action="user_update.action?finduserid=${sessionScope.loginuser.userId}" method="post" enctype="multipart/form-data"  class="infoForm">
			<h3>
				昵  称:&nbsp;&nbsp;"${sessionScope.loginuser.userName}" <br><br>
				密  码:&nbsp;&nbsp;<input type="password" class="input"  value="${sessionScope.loginuser.userPassword}" onfocus="javascript:if(this.value=='${sessionScope.loginuser.userPassword}')this.value=''"  name="userPassword"/><br><br>
				学  校:&nbsp;&nbsp;<input type="text" class="input"  name="userSchool"value="${sessionScope.loginuser.userSchool}" onfocus="javascript:if(this.value=='${sessionScope.loginuser.userSchool}')this.value=''" /><br><br>
				<div id="img">头  像:&nbsp;&nbsp;<img src="${sessionScope.loginuser.userImage}"  width="80" height="80"></div><br/>
				<input  class="input" type="file" name="upload" /><br><br>
				手机号:&nbsp;&nbsp;<input type="text" class="input"  name="userPhone" value="${sessionScope.loginuser.userPhone}" onfocus="javascript:if(this.value=='${sessionScope.loginuser.userPhone}')this.value=''" /><br><br>
				收件人:&nbsp;&nbsp;<input type="text" class="input"  name="userConsignee" value="${sessionScope.loginuser.userConsignee}" onfocus="javascript:if(this.value=='${sessionScope.loginuser.userConsignee}')this.value=''" /><br><br>
				地  址:&nbsp;&nbsp;<input type="text" class="input"   name="userAdress" value="${sessionScope.loginuser.userAdress}" onfocus="javascript:if(this.value=='${sessionScope.loginuser.userAdress}')this.value=''" /><br><br>
				邮  编:&nbsp;&nbsp;<input type="text" class="input"   name="userCode" value="${sessionScope.loginuser.userCode}" onfocus="javascript:if(this.value=='${sessionScope.loginuser.userCode}')this.value=''" /><br><br>
			</h3>
		<input type="submit" value="修改" class="sub" style="background-color:#ff3366"/>
		</form>
		<br/>
		<div class="deleteUser" align="center">
			<form action="user_deleteUser.action?finduserid=${sessionScope.loginuser.userId}" method="post" >
				<input type="submit" value="删除用户" class="sub" >
			</form>
		</div>
